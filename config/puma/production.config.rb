...
#
pidfile "#{root_path}/tmp/pids/production.puma.pid"

# Use "path" as the file to store the server info state. This is
# used by "pumactl" to query and control the server.
#
state_path "#{root_path}/tmp/sockets/production.puma.state"
...
stdout_redirect "#{root_path}/log/production.puma.stdout", "#{root_path}/log/production.puma.stderr", true
